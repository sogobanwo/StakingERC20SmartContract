...
contract StakingContract {
    ...
    uint immutable maxStake;
    uint immutable minStake;
    uint immutable minDeposit;
    uint immutable maxDeposit;
    ...
    constructor(address _stakeToken, uint _stakingDuration, uint _inverseRewardRate, uint _minDeposit, uint _maxDeposit, uint _maxStake, uint _minStake) {
    ...
    function depositToWallet(uint _amount) external{
        ...
        require(_amount <= maxDeposit, "more than the max deposit");
    ...
    function stake(uint _amount) external{
        ...
        require(_amount <= maxStake, "more than max Stake");
